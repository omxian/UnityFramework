/*
	...
	1)
		...
		Multi-frame emoji name format : Name_Index.png (base 1), Single frame emoji format: Name.png
	2)
...
public class EmojiBuilder  {
	...
	private const string OutputPath = "Assets/ArtResource/Emoji/Output/";
	private const string InputPath = "/ArtResource/Emoji/Input/";
